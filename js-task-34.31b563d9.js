...
},{"./js/app.js":"9f5IL","./js/modal.js":"jJ31c"}],"9f5IL":[function(require,module,exports,__globalThis) {
...
},{"./get-cards-layout":"b5OXE","./set-cards-layout":"dIZLZ"}],"b5OXE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCardsLayout", ()=>getCardsLayout);
const getCardsLayout = (page)=>fetch(`https://pixabay.com/api/?key=49666473-3abe1c6e3c5239c6859051d04&lang=en&orientation=horizontal&category=places&editors_choice=true&per_page=4&page=${page}`).then((reponse)=>reponse.json());
...
},{}],"dIZLZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setCardsLayout", ()=>setCardsLayout);
const setCardsLayout = (cards)=>{
    cards.forEach((card)=>{
        document.querySelector("#cards-list").insertAdjacentHTML("beforeend", `<li id="${card.id}" class="cards__item">
...
list.addEventListener("click", (e)=>{
    if (e.target.nodeName === "BUTTON") fetch(`https://pixabay.com/api/?key=49666473-3abe1c6e3c5239c6859051d04&id=${e.target.parentElement.id}`).then((reponse)=>reponse.json()).then((obj)=>{
        const { hits } = obj;
        const [card] = hits;
        console.log(card);
        ...
        backdrop.querySelector(`[data-role="downloads"]`).textContent = card.downloads;
        backdrop.querySelector(`[data-role="likes"]`).textContent = card.likes;
        backdrop.querySelector(`[data-role="collections"]`).textContent = card.collections;
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire1fb7", {})

//# sourceMappingURL=js-task-34.31b563d9.js.map
